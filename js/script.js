...
var scoreText={
  ...
  update:function(text){
    gamearea.context.fillStyle="#2c2c2c";
...
var player={
  ...
  update:function(){
    if(this.y<470)
    {
    gamearea.context.drawImage(standimage,this.x,this.y-80,60,60);
    }
    else
    {
    gamearea.context.drawImage(standimage,this.x,this.y-80,50,60);
    } 
  },
  newPos:function(){
    if(this.y<280){
...
function obstacle(){
  ...
  this.draw=function(){
    ...
    {
      gamearea.context.drawImage(cactus,this.x,this.y-58,45,this.height+15);
    }
    else if(this.enemytype=="cactuss")
    {
       gamearea.context.drawImage(cactus2image,this.x,this.y-58,45,this.height+15);
    }
    else
    {
       gamearea.context.drawImage(flyingdinosaur,this.x,this.y-90,60,this.height+10);
    }
  }
  }
...
var gamearea={
  ...
  stop:function(){
    ...
    gamearea.context.fillText("FIM DE JOGO!!!",300,150);
